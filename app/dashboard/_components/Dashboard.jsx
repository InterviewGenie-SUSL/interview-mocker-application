...
const Dashboard = () => {
  ...
  const handleDeleteInterview = async (mockId) => {
    try {
      ...
      setInterviewData(prev => prev.filter(interview => interview.mockId !== mockId));
      setFilteredData(prev => prev.filter(interview => interview.mockId !== mockId));
    } catch (error) {
    ...
    >
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <motion.div variants={itemVariants} className="text-center space-y-4">
          ...
          >
            Ready to ace your next interview? Let's practice and build your confidence!
          </motion.p>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          <motion.div
            className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 p-8 text-white shadow-2xl"
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Unlimited interviews • AI feedback • Premium features</p>
                </div>
              </div>
              <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {statCards.map((stat, index) => (
              <motion.div
                ...
                whileHover="hover"
                className="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-6 shadow-lg border border-gray-200 dark:border-gray-700"
              >
                <motion.div
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 items-center">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-blue-500 transition-colors duration-300"
            />
          </div>
          <div className="flex gap-2">
            <motion.select
              ...
              className="px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-blue-500 transition-colors duration-300"
            >
        ...
        </motion.div>        {/* Previous Interview Cards */}
        <motion.div variants={itemVariants}>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">
              {filteredData.length} interview{filteredData.length !== 1 ? 's' : ''} found
            </span>
          </div>
